    ...
    <div>
      ...
      <div className='mt-12'>
        ...
        <ul className=' pt-4 md:p-5'>
          ...
          <li className=' flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px] '>
            <div>
              <span className=' text-irisBlueColor text-[15px] leading-6 font-semibold '>{formateDate('07-04-2010')} - {formateDate('07-13-2014')}</span>
      ...
      <h3 className="text-[20px] leading-[30px) ☐ text-headingColor font-semibold ">Experience
        ...
        <ul className="grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5">
          <li className='p-4 rounded bg-[#fff9ea]'  >
            <span className="text-yellowColor text-[15px] leading-6 font-semibold">{formateDate('07-04-2010')} - {formateDate('07-13-2014')}</span>
